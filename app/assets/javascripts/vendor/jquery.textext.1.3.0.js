...
(function (a, b) {
    ...
    p = d.prototype, p
        ...
        var c = [],
            d, e;
        for (d = 0; d < a.length; d++) e = a[d], this.itemContains(e, b) && c
            .push(e);
        return c
    }, p.itemContains = function (a, b) {
        return this.itemToString(a)
            .toLowerCase()
        ...
        d._defaults = a
            ...
            ._opts = c || {}, d
            ._plugins = {}, d
            ._itemManager = f = new(d.opts(i)), b = a(b), g = a(d.opts(l)), e = a(d.opts(m)), b
            .wrap(g)
            .keydown(function (a) {
            ...
            .data({
                hiddenInput: e,
                wrapElement: b.parents(".text-wrap")
                    .first(),
                input: b
            }), e
            ...
            .attr("name", null), e
            .insertAfter(b), a
            .extend(!0, f, d.opts(k + ".item.manager")), a
            .extend(!0, d, d.opts(k + ".*"), d
            .opts(k + ".core")), d
            .originalWidth = b
            .outerWidth(), d
            .invalidateBounds(), f
        ...
        for (i = 0; i < b.length; i++) f = b[i], g = c[f], g && (d._plugins[f] = g = new g, d[f] = function (a) {
            ...
            .extend(!0, g, d.opts(k + ".*"), d
            .opts(k + "." + f)));
        h.sort(function (a, b) {
            return a = a.initPriority(), b = b
                .initPriority(), a === b ? 0 : a < b ? 1 : -1
        });
        ...
        p["onKey" + a] = function (b) {
            var c = this,
                ...
                e = !0;
            return d && (e = d.substr(-1) != "!", d = d
                .replace("!", ""), c
                .trigger(d + "Key" + a), a == "Up" && c
                ._lastKeyDown == b
                .keyCode && (c._lastKeyDown = null, c
                .trigger(d + "KeyPress")), a == "Down" && (c._lastKeyDown = b
                .keyCode)), c.trigger("anyKey" + a, b.keyCode), e
        }
    }), p = e
        .prototype, p
        .on = y, p
        ...
        var d = this;
        b._defaults = a
            .extend(!0, b._defaults, c), d
            ._core = b, d
            ._timers = {}
    }, p.startTimer = function (a, b, c) {
        var d = this;
        d.stopTimer(a), d
            ._timers[a] = setTimeout(function () {
            delete d._timers[a], c
                .apply(d)
        }, b * 1e3)
    ...
    var A = !1,
        B = a.fn
            ...
            return !A && (d = a.fn
                .textext
                .css) != null && (a("head").append("<style>" + d + "</style>"), A = !0), this.map(function () {
                var d = a(this);
...
(function (a) {
    ...
    c.init = function (a) {
        ...
        var a = this;
        a.dontShowLoading(), a
            .startTimer(k, a.opts(f), function () {
...
(function (a) {
    ...
    c.init = function (b) {
        ...
        this.trigger("toggleDropdown"), this
            .core()
            .focusInput()
    }
})(jQuery);
(function (a) {
    ...
    a.fn
        .textext
        .TextExtAutocomplete = b, a
        .fn
        .textext
        .addPlugin("autocomplete", b);
    var c = b.prototype,
        d = ".",
        e = "text-selected",
        f = d + e,
    ...
    c.init = function (b) {
        ...
        c.opts(k) === !0 && (c.on({
            ...
            .css("maxHeight", c.opts(m))
            .addClass("text-position-" + c.opts(l)), a(c)
            .data("container", e), a(document.body)
            .click(function (a) {
                c.isDropdownVisible() && !c
                    .withinWrapElement(a.target) && c
                    .trigger(q)
            }), c
            .positionDropdown())
        ...
        var c = this,
            d = a(b.target);
        (d.is(h) || d
            .is(j)) && c.trigger("enterKeyPress"), c
            .core()
            .hasPlugin("tags") && c
            .val("")
    }, c.onBlur = function (a) {
        ...
        var b = this;
        b.isDropdownVisible() ? b
            .toggleNextSuggestion() : b
            .getSuggestions()
        ...
        for (i = 0; i < d.length; i++) {
            h = a(d[i]);
            if (c.itemManager()
                .compareItems(h.data(g), b)) {
                f = h.addClass(e);
                break
            }
        }
        f.addClass(e), c
            .scrollSuggestionIntoView(f)
        ...
        var b = this;
        b.trigger(b.containerElement()
            .is(":visible") ? q : r)
    }, c.onShowDropdown = function (b, c) {
        var d = this,
            e = d.selectedSuggestionElement()
                .data(g),
            f = d._suggestions;
        if (!f) return d.trigger(s);
        a.isFunction(c) ? c(d) : (d.renderSuggestions(d._suggestions), d
            .toggleNextSuggestion()), d
            .showDropdown(d.containerElement()), d
            .setSelectedSuggestion(e)
    }, c.onSetSuggestions = function (a, b) {
        var c = this,
            d = c._suggestions = b
                .result;
        b.showHideDropdown !== !1 && c
            .trigger(d === null || d.length === 0 ? q : r)
    }, c.getSuggestions = function () {
        var a = this,
            b = a.val();
        if (a._previousInputValue == b) return;
        b == "" && (current = null), a._previousInputValue = b, a
            .trigger(s, {
                query: b
            })
        ...
        var a = this,
            b = a.containerElement();
        a._previousInputValue = null, b
            .hide()
    }, c.addSuggestion = function (a) {
        var b = this,
            c = b.opts(n),
            d = b.addDropdownItem(c ? c.call(b, a) : b
                .itemManager()
                .itemToString(a));
        d.data(g, a)
    }, c.addDropdownItem = function (b) {
        var c = this,
            d = c.containerElement()
                .find(".text-list"),
            e = a(c.opts(p));
        return e.find(".text-label")
            .html(b), d
            .append(e), e
        ...
        var a = this,
            ...
            c;
        b.length > 0 ? (c = b.next(), c
            .length > 0 && b
            .removeClass(e)) : c = a
            .suggestionElements()
            .first(), c
            .addClass(e), a
            .scrollSuggestionIntoView(c)
        ...
        var a = this,
            b = a.selectedSuggestionElement()
                .data(g);
        b && (a.val(a.itemManager()
            .itemToString(b)), a
            .core()
            .getFormData()), a.trigger(q)
...
(function (a) {
    ...
    c.init = function (a) {
        ...
        var d = this,
            ...
            g = "";
        d.core()
            .hasPlugin("tags") || (d.isValueAllowed(f) && (g = e), b[300] = d
            .formDataObject(f, g))
    }, c.isValueAllowed = function (a) {
        var b = this,
            c = b.opts("filterItems") || b
                ._suggestions || [],
            e = b.itemManager(),
            f = !b.opts(d),
            g;
...
(function (a) {
    ...
    c.init = function (a) {
        ...
        var b = this;
        clearTimeout(b._timeoutId), b.getFocus()
            .show()
    }, c.getFocus = function () {
        return this.core()
            .wrapElement()
...
(function (a) {
    ...
    c.init = function (b) {
        var c = this,
            d = "placeholder",
            h, i;
        c.baseInit(b, g), h = a(c.opts(f)), a(c)
            .data("container", h), c
            .core()
            .wrapElement()
            .append(h), c
            .setPrompt(c.opts(e)), i = b
            .input()
            .attr(d), i || (i = c.opts(e)), b
            .input()
            .attr(d, ""), i && c
            .setPrompt(i), a
            .trim(c.val())
...
(function (a) {
    ...
    a.fn
        .textext
        .TextExtSuggestions = b, a
        .fn
        .textext
        .addPlugin("suggestions", b);
    var c = b.prototype,
        d = "suggestions",
        e = {
            suggestions: null
...
(function (a) {
    ...
    c.init = function (b) {
        ...
        var c = this,
            d = c.input(),
            e;
        c.opts(o) && (e = a(c.opts(r)), d.after(e), a(c)
            .data("container", e), c
            .on({
                enterKeyPress: c.onEnterKeyPress,
        ...
        var c = this,
            ...
            i;
        e.is(j) ? f = 1 : e
            .is(n) ? (c.removeTag(e.parents(h + ":first")), f = 1) : e
            .is(l) && (i = e.parents(h + ":first"), c
            .trigger(t, i, i.data(g), k)), f && d
            .focusInput()
    }, c.onEnterKeyPress = function (a) {
        var b = this,
            c = b.val(),
            d = b.itemManager()
                .stringToItem(c);
        b.isTagAllowed(d) && (b.addTags([d]), b
            .core()
            .focusInput())
        ...
        var b = this,
            ...
            e, f;
        for (e = 0; e < a.length; e++) f = a[e], f && b.isTagAllowed(f) && d
            .append(b.renderTag(f));
        b.updateFormCache(), c
            .getFormData(), c
            .invalidateBounds()
        ...
        var c = this,
            d = c.tagElements(),
            e, f;
        for (e = 0; e < d.length, f = a(d[e]); e++) if (c.itemManager()
            .compareItems(f.data(g), b)) return f
    }, c.removeTag = function (b) {
        var c = this,
            d = c.core(),
            e;
        b instanceof a ? (e = b, b = b.data(g)) : e = c.getTagElement(b), e
            .remove(), c
            .updateFormCache(), d
            .getFormData(), d
            .invalidateBounds()
...
(function (a) {
    ...
    '.text-core{position:relative;}n.text-core .text-wrap{background:#fff;position:absolute;}n.text-core .text-wrap textarea,.text-core .text-wrap input{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;-webkit-border-radius:0;-moz-border-radius:0;border-radius:0;border:1px solid #9daccc;outline:none;resize:none;position:absolute;z-index:1;background:none;overflow:hidden;white-space:nowrap;font:11px "lucida grande",tahoma,verdana,arial,sans-serif;line-height:13px;height:auto;margin:0;padding:3px 5px 4px;}nn.text-core .text-wrap .text-arrow{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;top:0;left:0;width:22px;height:22px;background:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAOAQMAAADHWqTrAAAAA3NCSVQICAjb4U/gAAAABlBMVEX///8yXJnt8Ns4AAAACXBIWXMAAAsSAAALEgHS3X78AAAAHHRFWHRTb2Z0d2FyZQBBZG9iZSBGaXJld29ya3MgQ1MzmNZGAwAAABpJREFUCJljYEAF/xsY6hkY7BgYZBgYOFBkADkdAmFDagYFAAAAAElFTkSuQmCC) 50% 50% no-repeat;cursor:pointer;z-index:2;}nn.text-core .text-wrap .text-dropdown{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;z-index:3;background:#fff;border:1px solid #9daccc;width:100%;max-height:100px;font:11px "lucida grande",tahoma,verdana,arial,sans-serif;display:none;overflow-x:hidden;overflow-y:auto;padding:1px;}n.text-core .text-wrap .text-dropdown.text-position-below{margin-top:1px;}n.text-core .text-wrap .text-dropdown.text-position-above{margin-bottom:1px;}n.text-core .text-wrap .text-dropdown .text-list .text-suggestion{cursor:pointer;padding:3px 5px;}n.text-core .text-wrap .text-dropdown .text-list .text-suggestion em{font-style:normal;text-decoration:underline;}n.text-core .text-wrap .text-dropdown .text-list .text-suggestion.text-selected{color:#fff;background:#6d84b4;}nn.text-core .text-wrap .text-focus{-webkit-box-shadow:0 0 6px #6d84b4;-moz-box-shadow:0 0 6px #6d84b4;box-shadow:0 0 6px #6d84b4;position:absolute;width:100%;height:100%;display:none;}n.text-core .text-wrap .text-focus.text-show-focus{display:block;}nn.text-core .text-wrap .text-prompt{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;width:100%;height:100%;font:11px "lucida grande",tahoma,verdana,arial,sans-serif;color:silver;overflow:hidden;white-space:pre;margin:1px 2px 0 0;}n.text-core .text-wrap .text-prompt.text-hide-prompt{display:none;}nn.text-core .text-wrap .text-tags{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;width:100%;height:100%;cursor:text;padding:3px 3px 3px 35px;}n.text-core .text-wrap .text-tags.text-tags-on-top{z-index:2;}n.text-core .text-wrap .text-tags .text-tag{float:right;}n.text-core .text-wrap .text-tags .text-tag .text-button{-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:relative;float:right;border:1px solid #9daccc;background:#e2e6f0;color:#000;cursor:pointer;height:16px;font:11px "lucida grande",tahoma,verdana,arial,sans-serif;margin:0 0 2px 2px;padding:0 3px 0 17px;}n.text-core .text-wrap .text-tags .text-tag .text-button a.text-remove{position:absolute;left:3px;top:2px;display:block;width:11px;height:11px;background:url(data:image/png;base64,) 0 0 no-repeat;}n.text-core .text-wrap .text-tags .text-tag .text-button a.text-remove:hover{background-position:0 -11px;}n.text-core .text-wrap .text-tags .text-tag .text-button a.text-remove:active{background-position:0 -22px;}'
);